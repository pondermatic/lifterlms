...
class LLMS_Settings_Accounts extends LLMS_Settings_Page {
	...
	public function get_sections() {
		...
		return apply_filters( 'llms_' . $this->id . '_settings_sections',  array(
			'main' => __( 'Student Dashboard', 'lifterlms' ),
			'user_info' => __( 'User Information', 'lifterlms' ),
	...
	public function get_settings() {
		...
		if ( 'main' === $curr_section ) {
			...
			$settings = array(
				...
				array(
					'id' => 'recaptcha_title',
					'title' => __( 'Google reCAPTCHA', 'lifterlms' ),
					'type' => 'title',
				),
				...
				array(
					'autoload' => false,
					'default' => 'no',
					'id' => 'llms_enable_recaptcha',
					'desc' => __( 'Prevent bots from registering student accounts using Google reCAPTCHA.', 'lifterlms' ),
					'title' => __( 'Enable reCAPTCHA', 'lifterlms' ),
					'type' => 'checkbox',
					'custom_attributes' => array(
						'class' => 'llms-conditional-controller',
						'data-controls' => '#llms_recaptcha_site_key,#llms_recaptcha_secret_key',
					),
				),

				array(
					'autoload' => false,
					'title' => __( 'Site Key', 'lifterlms' ),
					'desc' 		=> '<br>' . __( 'Allows reCAPTCHA to identify your site.', 'lifterlms' ),
					'id' 		=> 'llms_recaptcha_site_key',
					'type' 		=> 'text',
				),
				...
				array(
					...
					'desc' 		=> '<br>' . __( 'Allows your site to interact with the reCAPTCHA service.', 'lifterlms' ),
					'id' 		=> 'llms_recaptcha_secret_key',
					'type' 		=> 'text',
				),
		...
		return apply_filters( 'lifterlms_' . $this->id . '_settings', $settings, $curr_section );
	}
